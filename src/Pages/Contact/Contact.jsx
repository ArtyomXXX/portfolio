                ...
                <div className={styles["contact"]}>
                    <div className={styles["contact__inner"]}>
                        ...
                        <div className={styles["contact__item--mobile"]}>
                            <div>
                                <h2>Контакты для связи:</h2>
                                <p>Телефон:&nbsp;&nbsp;<a href="tel:+79284467650">+7(928)446-76-50</a></p>
                                <p>Телеграмм:&nbsp;&nbsp;<a href="https://t.me/Anbu5656" target="_blank" rel="noreferrer">https://t.me/Anbu5656</a></p>
                                <p>Email:&nbsp;&nbsp;<a href="mailto:ambartsumyanartyomxxx@gmail.com&&cc=ambartsumyanartyomxxx@gmail.com?" target="_blank" rel="noreferrer">ambartsumyanartyomxxx@gmail.com</a></p>
                            </div>
                            <div>
                                <h2>Моё резюме:</h2>
